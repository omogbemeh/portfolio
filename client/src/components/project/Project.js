                        ...
                        <div className='projects'>
                            <div className="project-item">
                                <div className='project-title'>
                                    <h4>DevConnector</h4>
                                    <a className='show-big' href='https://arcane-plains-01847.herokuapp.com/'><img className='project-img' src={devconnect} alt=""/></a>
                                </div>
                                <div className="project-desc">
                                    ...
                                    <p>You can check it out <a className='project-link' href='https://omogbemeh.github.io/theRosa/'>here</a></p>
                                    <p>You can get the code from <a href='https://arcane-plains-01847.herokuapp.com/'><i className="fab fa-github"></i></a></p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className='projects'>
                            <div className="project-item">
                                <div className='project-title'>
                                    ...
                                    <a className='show-big' href='https://omogbemeh.github.io/theRosa/'><img className='project-img' src={rosa} alt=""/></a>
                                </div>
                                <div className="project-desc">
                                    ...
                                    <p>You can check it out <a className='project-link' href='https://omogbemeh.github.io/theRosa/'>here</a></p>
                                    <p>You can get the code from <a href='https://github.com/omogbemeh/theRosa'><i className="fab fa-github"></i></a></p>
                                </div>
                            </div>
                        </div>
                    </div>
